sap.ui.define(
    ...
    function (JSONModel, Controller) {
        ...
        return Controller.extend("sap.test.routing.controller.App", {
            onInit: function () {
            ...
            onRouteMatched: function (oEvent) {
                ...
                // console.log(oArguments.product, "oArguments.product");
            ...
            onStateChanged: function (oEvent) {
                var bIsNavigationArrow =
                        oEvent.getParameter("isNavigationArrow"),
